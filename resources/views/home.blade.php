        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 banner-left">
                    <h1 class="text-uppercase">ARTIST APP</h1>
                    <p>Somos la mejor galeria artistica de la red </p>
                    <a class="video-btn primary-btn" href="about-us.html">Leer mas</a>
                </div>
                <div class="col-md-6 banner-right text-center">
                    <img class="img-fluid" src="../img/cuadro.jfif" alt="">
                </div>
            </div>
        </div>
        <div class="wave">
